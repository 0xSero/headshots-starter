      ...
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center mb-8">
          <Badge className="mb-4" variant="outline">
            AUTENTYCZNE ZDJĘCIA BIZNESOWE AI
          </Badge>
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
            Profesjonalne Zdjęcia Profilowe z <span className="text-primary">Ludzkim Charakterem</span>
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl max-w-[800px] mx-auto">
            Zamień swoje selfie w naturalne zdjęcia biznesowe w kilka minut. Oszczędź setki złotych i godziny czasu.
          </p>
